...
<RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            movieNameTextView = itemView.findViewById(R.id.homeMovieName);
            releaseDateTextView = itemView.findViewById(R.id.homeReleaseDate);
            ratingBarView =itemView.findViewById(R.id.homeRatingBar);
        }
    }
    @Override
